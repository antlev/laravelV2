...
<link rel="stylesheet" href="<?php echo e(asset('css/custom-icon.css')); ?>">


<input type="hidden" id="authname" value="<?php echo e(Auth::user()->name); ?>">
<input type="hidden" id="authid" value="<?php echo e(Auth::id()); ?>">
<input type="hidden" id="sport" value="<?php echo e(Auth::user()->sport); ?>">
<input type="hidden" id="dateshout" value="">


    <script src="<?php echo e(asset('js/jquery-2.1.1.min.js')); ?>"></script>

        <script src="<?php echo e(asset('js/shoutbox.js')); ?>"></script>
