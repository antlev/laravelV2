                            ...
                            <div class="table-responsive">
                                <table class="table user-list">
                                    ...
                                    <?php foreach($data as $users): ?>
                                        <tr>
                                        <td>
                                          <?php if($users['photo']!=""): ?>  <img src="<?php echo e($users['photo']); ?>" alt="">
                                            <?php else: ?>
                                                <?php if($users['civilite']=='homme'): ?> <img src="http://bootdey.com/img/Content/user_3.jpg" alt="">
                                                    <?php else: ?> <img src="http://bootdey.com/img/Content/user_2.jpg" alt=""> <?php endif; ?>

                                        <?php endif; ?>
                                            <a href='#' id="members_<?php echo e($users['id']); ?>" class="user-link"><?php echo e($users['name']); ?></a>
                                            <span class="user-subhead"><?php echo e($users['ville']); ?></span>
                                        </td>
                                        <td>2013/08/12</td>
                                        <td class="text-center">
                                            <span class="label label-success"><?php echo e($users['sport']); ?></span>
                                        </td>
                                        <td>
                                        ...
                                        <td style="width: 20%;">
                                            ...
                                            <span class="fa-stack">
                                                ...
                                                <i class="fa fa-envelope fa-stack-1x fa-inverse" data-toggle="modal" data-target="#MessageIt" onclick="$('#keepid').val('<?php echo e($users['id']); ?>'),$('#keepname').val('<?php echo e($users['name']); ?>')"></i>
                                            </span>
                                            </a>
